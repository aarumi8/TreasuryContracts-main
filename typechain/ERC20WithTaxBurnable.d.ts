...
interface ERC20WithTaxBurnableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20WithTaxBurnable extends BaseContract {
  ...
  interface: ERC20WithTaxBurnableInterface;
