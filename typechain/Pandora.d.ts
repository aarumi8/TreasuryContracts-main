...
interface PandoraInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setDataURI(string)": FunctionFragment;
...
export class Pandora extends BaseContract {
  ...
  callStatic: {
    ...
    setDataURI(_dataURI: string, overrides?: CallOverrides): Promise<void>;
